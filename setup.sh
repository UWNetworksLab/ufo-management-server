...
function addAllExports ()
{
  ...
  runAndAssertCmd "echo export PATH=$PATH:$AE_PYTHON_LOCAL_DIR:$AE_PYTHON_LOCAL_DIR/:$AE_PYTHON_LOCAL_DIR/lib:$AE_PYTHON_LOCAL_DIR/lib/:$AE_PYTHON_LOCAL_DIR/lib/webapp2-2.5.2:$AE_PYTHON_LOCAL_DIR/lib/webapp2-2.5.2/:$AE_PYTHON_LOCAL_DIR/lib/webob-1.2.3:$AE_PYTHON_LOCAL_DIR/lib/webob-1.2.3/ >> $TEMP_BASH_PROFILE"
  runAndAssertCmd "echo export PYTHONPATH=$PYTHONPATH:$AE_PYTHON_LOCAL_DIR:$AE_PYTHON_LOCAL_DIR/:$AE_PYTHON_LOCAL_DIR/lib:$AE_PYTHON_LOCAL_DIR/lib/:$AE_PYTHON_LOCAL_DIR/lib/webapp2-2.5.2:$AE_PYTHON_LOCAL_DIR/lib/webapp2-2.5.2/:$AE_PYTHON_LOCAL_DIR/lib/webob-1.2.3:$AE_PYTHON_LOCAL_DIR/lib/webob-1.2.3/ >> $TEMP_BASH_PROFILE"
